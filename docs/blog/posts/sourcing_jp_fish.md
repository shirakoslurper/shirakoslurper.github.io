...
> A good number of restaurants in Japan selling local ingredients actually have to "buy back" from Toyosu, since it's such a critical and overwhelmingly dominant distribution hub. There are a select few restaurants where this isn't the case - they establish relationships with fisherman or buy from the lcoal port's markets directly.
...
Sol Japan seems more aggressively pursuing U.S. distribution, however. Yokose is nearly a one man operation.

> Yokose's socials and sites aren't often updated and the availability and hours are irregular (the proprietor does deliveries to restaurants), so it's best to give him a call. He seems like a sweetheart, though.